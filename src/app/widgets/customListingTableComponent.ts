...
import { EntityTypeComponent, ListingTableComponent } from "angularm";
...
@Component({
  ...
  template: `<div *ngIf="entityType">
    ...
    <table>
      <thead>
        <tr>
          <th [ngClass] = "configuration.listtable"  *ngFor="let propertyType of entityType.propertyTypes">{{propertyType.name | titleCase}}</th>
          <th colspan="3"></th>
        </tr>
      </thead>
      <tbody>
